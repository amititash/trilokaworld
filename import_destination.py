...
def import_destination():
    if len(sys.argv) < 2:
        print("Usage: python3 import_destination.py <path_to_txt_file> [image_url]")
        print("Example: python3 import_destination.py ./new_place.txt https://example.com/image.jpg")
        return
    ...
    # 1. Location
    location = "Rajasthan, India" # Default
    ...
    print("Don't forget to run 'python3 sync_mongo_to_chroma.py' to update the AI!")
